...
แอปอ่านคำศัพท์ล่าสุดจาก `https://chinese.icejuk.dev/api/writing-exercises.json` ทุกครั้งที่เปิด (ไม่ใช้ cache) จึงเห็นบทที่เพิ่มหรือคำศัพท์ที่แก้จากเว็บต้นทางทันที โดยไม่มี backend หรือฐานข้อมูลของแอปเอง; เสียงอ่านขึ้นกับเสียงภาษาจีน/ไทยที่ติดตั้งในอุปกรณ์ โดยเสียงไทยจะพูดเร็วกว่าเสียงจีนประมาณ 1.7 เท่าในทุกระดับความเร็ว
